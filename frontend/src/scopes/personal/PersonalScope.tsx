        ...
        >
          ...
          <Box className="main-area">
            ...
            <Routes>
              ...
              <Route
                path="learning"
                element={<Learning isMobile={isMobile} />}
              />
              ...
              <Route
                path="diet/*"
                element={<NutritionPortal isMobile={isMobile} />}
              />
              <Route
                path="training"
                element={<Training isMobile={isMobile} />}
              />
