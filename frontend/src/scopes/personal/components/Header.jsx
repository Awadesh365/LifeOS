...
const destinations = [
  ['Dashboard', '/', 'Overview'],
  ['Daily Tracker', '/habits', 'Daily'],
  ['My Routine', '/routine', 'Daily'],
  ['Health', '/health', 'Daily'],
  ['Gym & Training', '/training', 'Daily'],
  ['Diet & Nutrition', '/diet', 'Daily'],
  ['Wealth Management', '/wealth', 'Finance'],
  ['Debt Tracker', '/debts', 'Finance'],
  ['Emergency Fund', '/funds', 'Finance'],
  ['Learning Paths', '/learning', 'Growth'],
  ['Job Tracker', '/jobs', 'Growth'],
  ['Career Development', '/career', 'Growth'],
  ['Networking', '/networking', 'People'],
  ['All Projects', '/projects', 'Projects'],
  ['The Manifesto', '/articles', 'Knowledge'],
  ['Goals & Dreams', '/goals', 'Vision'],
  ['Future Plans', '/future-plans', 'Vision'],
  ['Core Philosophy', '/philosophy', 'Vision'],
];
