...
export const modules: LifeModule[] = [
  ...
  { slug: 'wealth', title: 'Wealth', description: 'Income and expenses', endpoint: '/wealth/entries', icon: 'wallet-outline', primaryKeys: ['category', 'type'], secondaryKeys: ['amount', 'account', 'date'] },
  { slug: 'debts', title: 'Debts', description: 'Balances and payoff plans', endpoint: '/debts', icon: 'credit-card-outline', primaryKeys: ['personName'], secondaryKeys: ['remainingAmount', 'status', 'targetMonth'] },
  { slug: 'funds', title: 'Emergency funds', description: 'Your financial buffer', endpoint: '/funds', icon: 'shield-check-outline', primaryKeys: ['bankName'], secondaryKeys: ['amount', 'targetAmount', 'type'] },
