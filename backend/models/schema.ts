...
export const defineLifeTrackerModels = (sequelize: Sequelize): LifeTrackerModels => {
  ...
  const MaintenanceItem = sequelize.define('MaintenanceItem', {
    ...
    workKind: { type: DataTypes.STRING(30), allowNull: false, defaultValue: 'routine', field: 'work_kind' },
  ...
  const MaintenanceOccurrence = sequelize.define('MaintenanceOccurrence', {
    ...
    clientOperationId: { type: DataTypes.STRING(120), field: 'client_operation_id' },
    scheduleVersion: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 1, field: 'schedule_version' },
    plannedDate: { type: DataTypes.STRING(10), field: 'planned_date' },
    windowStart: { type: DataTypes.STRING(10), field: 'window_start' },
    windowEnd: { type: DataTypes.STRING(10), field: 'window_end' },
    hardDueAt: { type: DataTypes.STRING(10), field: 'hard_due_at' },
    completedAt: { type: DataTypes.DATE, field: 'completed_at' },
